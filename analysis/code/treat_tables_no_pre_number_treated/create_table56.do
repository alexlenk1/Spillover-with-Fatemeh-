...
file open file2 using "$repository/analysis/tables/treat_tables_no_pre_number_treated/table5.tex", replace write
...
file open file3 using "$repository/analysis/tables/treat_tables_no_pre_number_treated/table6.tex", replace write
