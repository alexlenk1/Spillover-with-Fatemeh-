...
**Create Table 3
file open file0 using "$repository/analysis/tables/treat_tables_no_pre_number_treated/table3.tex", replace write
...
file open file1 using "$repository/analysis/tables/treat_tables_no_pre_number_treated/table4.tex", replace write
