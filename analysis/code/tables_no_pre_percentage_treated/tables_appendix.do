...
file open file16 using "$repository/analysis/tables/tables_no_pre_percentage_treated/table19_OLS.tex", replace write
...
file open file17 using "$repository/analysis/tables/tables_no_pre_percentage_treated/table20_FE.tex", replace write
...
file open file18 using "$repository/analysis/tables/tables_no_pre_percentage_treated/table21_RE.tex", replace write
