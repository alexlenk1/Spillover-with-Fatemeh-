...
file open file9 using "$repository/analysis/tables/tables_no_pre_number_treated/table11a_races_own_other_race.tex", replace write
...
file write file9 _n "& \multicolumn{6}{c}{Spillover from Own Race Neighbors}\\"
