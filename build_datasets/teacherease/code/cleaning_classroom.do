...
local input_dir "$repository/build_datasets/teacherease/input"
...
local not crosswalk_all.dta crosswalk_all2.dta unique_data_clean_for_panel.dta
...
bysort year gradingperioddescription firstname lastname classdescription child_birthday: egen mean_n_students = mean(n_students)
...
replace n_students =  mean_n_students if n_students !=  mean_n_students
